...
interface CodeToHastOptionsCommon<Languages extends string = string> extends TransformerOptions {
...
export { INITIAL as $, type AnsiLanguage as A, type BundledHighlighterOptions as B, type CodeToHastOptions as C, type ShikijiTransformerContextMeta as D, type Element as E, FontStyle as F, type ShikijiTransformerContext as G, type HighlighterGeneric as H, type IGrammar as I, type ShikijiTransformer as J, type HtmlRendererOptionsCommon as K, type LanguageInput as L, type MaybeArray as M, type HtmlRendererOptions as N, type ThemedTokenScopeExplanation as O, type PlainTextLanguage as P, type ThemedTokenExplanation as Q, type Root as R, type ShikiInternal as S, type ThemeInput as T, type TokenBase as U, type TokenStyles as V, type DynamicImportLanguageRegistration as W, type DynamicImportThemeRegistration as X, type BundledLanguageInfo as Y, type BundledThemeInfo as Z, Registry as _, type HighlighterCoreOptions as a, type StateStack as a0, type IRawTheme as a1, type IGrammarConfiguration as a2, type IOnigLib as a3, type RegistryOptions as a4, type IRawThemeSetting as a5, type RequireKeys as b, type CodeToThemedTokensOptions as c, type ThemedToken as d, type CodeToTokensWithThemesOptions as e, type ThemedTokenWithVariants as f, type ThemeRegistrationResolved as g, type ShikijiTransformerContextCommon as h, type ThemeRegistrationAny as i, type IRawGrammar as j, type SpecialLanguage as k, loadWasm as l, type Awaitable as m, type MaybeGetter as n, type MaybeModule as o, type StringLiteralUnion as p, type ResolveBundleKey as q, type LanguageRegistration as r, type CodeToHastOptionsCommon as s, type CodeOptionsSingleTheme as t, type CodeOptionsMultipleThemes as u, type CodeOptionsThemes as v, type CodeOptionsMeta as w, type TransformerOptions as x, type ThemeRegistrationRaw as y, type ThemeRegistration as z };
